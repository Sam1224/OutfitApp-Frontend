    ...
    methods: {
      ...
      changePose(e) {
        ...
        reader.onload = function (e) {
          ...
          document.getElementById('selected_file_pose_image_canvas').toDataURL('image/png').replace(/^.*,/, '')
        }
      },
      changeCloth(e) {
        let it = this
        ...
        reader.onload = function (e) {
          ...
          document.getElementById('selected_file_cloth_image_canvas').toDataURL('image/png').replace(/^.*,/, '')
        }
      },
